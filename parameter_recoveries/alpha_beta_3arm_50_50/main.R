...
code_dir      <- file.path(project_root, "parameter_recoveries", "alpha_beta_3arm_50_50", "code")
artifacts_dir <- file.path(project_root, "parameter_recoveries", "alpha_beta_3arm_50_50", "artifacts")
output_dir    <- file.path(project_root, "parameter_recoveries", "alpha_beta_3arm_50_50", "output")
