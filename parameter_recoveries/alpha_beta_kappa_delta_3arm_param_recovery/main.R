...
code_dir      <- file.path(project_root, "parameter_recoveries", "alpha_beta_kappa_delta_3arm_param_recovery", "code")
artifacts_dir <- file.path(project_root, "parameter_recoveries", "alpha_beta_kappa_delta_3arm_param_recovery", "artifacts")
output_dir    <- file.path(project_root, "parameter_recoveries", "alpha_beta_kappa_delta_3arm_param_recovery", "output")
