...
code_dir      <- file.path(project_root, "analysis", "eval_only_param_recovery", "code")
artifacts_dir <- file.path(project_root, "analysis", "eval_only_param_recovery", "artifacts")
output_dir    <- file.path(project_root, "analysis", "eval_only_param_recovery", "output")

source(file.path(project_root, "models", "eval_only", "eval_only.R"))
