...
# alpha_rl
df_alpha_rl     <- data.frame(true_val = true_params$alpha_rl, recovered_val = recovered$alpha_rl) |> na.omit()
...
# alpha_per
df_alpha_per     <- data.frame(true_val = true_params$alpha_per, recovered_val = recovered$alpha_per) |> na.omit()
...
# beta_rl
df_beta_rl     <- data.frame(true_val = true_params$beta_rl, recovered_val = recovered$beta_rl) |> na.omit()
...
# beta_per
df_beta_per     <- data.frame(true_val = true_params$beta_per, recovered_val = recovered$beta_per) |> na.omit()
