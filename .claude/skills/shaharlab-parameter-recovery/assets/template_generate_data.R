...
Nsubjects <- 100     # sanity run: 10-50; full run: 100-200 (see RUN_CONVENTIONS.md)
Narms     <- 3
Ntrials   <- 200

# Reward probability schedule: Narms x Ntrials matrix.
# All arms have a constant 0.5 win rate — unbiased Narms-arm bandit.
...
# Individual-level samples drawn from population_params_list distributions.
