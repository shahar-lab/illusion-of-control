...
N_SIMS          = 10_000        # simulated games per scarcity level (use 10_000 for final run)
N_MACHINES      = 3
SCARCITY_LEVELS = np.round(np.arange(0.0, 1.05, 0.05), 2)
RNG_SEED        = 42
KAPPA           = 1.5       # perseveration bias (standard literature value)

# Human-typical parameter ranges (Daw 2011; Collins & Frank 2012; Ouden et al. 2013)
ALPHAS = [0.1, 0.2, 0.3, 0.5]   # learning rates
BETAS  = [1,   3,   6,   10]    # inverse temperatures
