...
data_path <- "simulations/eff_of_scarcity_on_wsls/alpha_beta_kappa_decay_uniform/data"
figs_path <- "simulations/eff_of_scarcity_on_wsls/alpha_beta_kappa_decay_uniform/figs"
